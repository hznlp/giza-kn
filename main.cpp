...
GLOBAL_PARAMETER3(bool,smooth_model1,"smooth_model1","smooth model 1","s1","kn smoothing for Model 1, 1 smooth, 0 (default) not",PARLEV_ITER,0);
GLOBAL_PARAMETER3(bool,smooth_model2,"smooth_model2","smooth model 2","s2","kn smoothing for Model 2, 1 smooth, 0 (default) not",PARLEV_ITER,0);
GLOBAL_PARAMETER3(bool,smooth_modelh,"smooth_modelh","smooth model h","sh","kn smoothing for Model HMM, 1 smooth, 0 (default) not",PARLEV_ITER,0);
GLOBAL_PARAMETER3(bool,smooth_model3,"smooth_model3","smooth model 3","s3","kn smoothing for Model 3, 1 smooth, 0 (default) not",PARLEV_ITER,0);
GLOBAL_PARAMETER3(bool,smooth_model4,"smooth_model4","smooth model 4","s4","kn smoothing for Model 4, 1 smooth, 0 (default) not",PARLEV_ITER,0);
